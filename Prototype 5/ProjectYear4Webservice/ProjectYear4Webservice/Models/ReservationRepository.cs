    ...
    public class ReservationRepository : IReservationRepository
    {
        ...
        public IEnumerable<ReservationDTO> GetAll()
        {
            var reserveDTO = from r in db.Reservations
                        ...
                        {
                            AttendeeID = r.MobileUser.MobileUserID,
        ...
        //{
        //    var findEvent = from r in db.Reservations
        //                where r.Event.EventName == eventName
        //                select new EventDTO()
        //                {
        //                    EventID = r.Event.EventID,
        //                    EventName = r.Event.EventName,
        //                    EventVenue = r.Event.EventVenue,
        //                    EventDate = r.Event.EventDate,
        //                    CreatorEmail = r.Event.CreatorEmail
        //                };
        //    return findEvent;
        //}
